                ...
                >
                    ...
                    <div className='absolute inset-0 z-5 flex w-full items-start justify-between p-12 lg:items-end'>
                        <Subtitle
                            ...
                            classes='left-0 w-1/4 text-balance'
                        >
                            Endless opportunities to connect with nature
                        </Subtitle>
                        <p
                            data-gsap='hero-footer-paragraph'
                            className='w-1/4 justify-evenly text-right text-body-medium text-balance'
                        >
                            Home to pristine forests, sparkling lakes and
                            wildlife. Whether you come to wander the trails,
                            rest by the water, or enjoy the stillness of the
                            wilderness, the park offers space to slow down and
                            reconnect.
                        </p>
                    </div>
                </div>
